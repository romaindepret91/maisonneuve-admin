            ...
            <div class="row mt-4">
                @forelse($blogposts as $blogpost)
                    <article class="blog-post mt-4">
                        <h2 class="blog-post-title mb-1">@if($blogpost->titre) {{ $blogpost->titre }} @else <i>No translation available</i> @endif</h2>
                        ...
                        <p>@if($blogpost->body) {{ $blogpost->body }} @else <i>No translation available</i> @endif</p>
