        ...
        <div class="col-10 pt-5">
            <div class="row align-items-center">
                ...
                <div class="col-4 d-flex justify-content-end align-items-center">
                    <a href="{{ route('blogArticles.index') }}" class="d-flex align-items-center btn btn-primary ms-2">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="{{ route('blogArticles.update', $blogpost) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="control-group">
                                @if(!empty($lang))
                                    <a href="{{ route('blogArticles.edit', $blogpost->id) }}" class="btn btn-warning mt-3 me-3">@lang('lang.text_back_button')</a>
                                @endif
